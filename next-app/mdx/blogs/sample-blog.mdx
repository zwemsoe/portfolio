...
lastUpdatedAt: 08-19-2021
tags: ['Frontend', 'React']
image: '/images/blog/theoffice.jpeg'
---

<CustomImage alt={`My LinkedIn Bio`} src={`/images/blog/theoffice.jpeg`} />
...
```js import {VStack} from '@chakra-ui/react'; import Navbar from './Navbar'; import
Contacts from './Contacts'; import Footer from './Footer';
